    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (isPartner) {
                ...
                const userData = response.data.user; // Ensure your backend sends this
             ...
             <div className="bg-white p-8 rounded-xl shadow-lg w-96 border border-gray-100">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <input 
                        ...
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-red-500 transition-colors text-gray-900"
                        required 
                    />
                    <input 
                        type="password" 
